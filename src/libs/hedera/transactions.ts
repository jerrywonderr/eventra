...
import { getHederaClient, getOperatorAccountId, getHederaNetwork } from './client';
...
export async function processTicketPurchaseTransaction(
  ...
  try {
    ...
    console.log(`Processing Hedera transaction: $${ticketPrice} = ${hbarAmount} HBAR`);
    ...
    const transaction = new TransferTransaction()
      ...
      .setTransactionMemo(`EventChain: Ticket purchase for event ${eventId.substring(0, 8)}`);
