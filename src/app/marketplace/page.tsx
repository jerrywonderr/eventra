    ...
    <div className="max-w-7xl mx-auto py-8 px-4">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-8">
        <p className="text-sm text-blue-800 dark:text-blue-200">
          💡 <strong>How it works:</strong> Buy verified tickets from other
          attendees. Original organizers receive royalties from each resale.
        </p>
      </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {listings
            ...
            .map((listing) => (
              ...
              >
                <div className="h-32 bg-gradient-to-br from-green-500 to-blue-600 flex items-center justify-center text-white text-5xl relative overflow-hidden">
                  {listing.ticket?.event?.image_url ? (
                    <Image
                      src={listing.ticket.event.image_url}
                      alt={listing.ticket.event.title || "Event"}
                      fill
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
                    📅{" "}
                    {new Date(
                      listing.ticket?.event?.event_date
                    ).toLocaleDateString()}
                  </p>
