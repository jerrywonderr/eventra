...
function ListForResaleButton({
  ...
  const href = `/resale/new?ticketId=${encodeURIComponent(String(ticketId))}${
    ticketPrice !== undefined
      ? `&price=${encodeURIComponent(String(ticketPrice))}`
      : ""
  }`;
  return (
    <Link
      ...
      {!tickets || tickets.length === 0 ? (
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {tickets.map((ticket) => (
            ...
            >
              {/* Ticket Header */}
              <div className="h-40 bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-6xl relative overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    ...
                    at {new Date(ticket.event?.event_date).toLocaleTimeString()}
                  </p>
                  <p className="text-sm text-slate-600 dark:text-slate-400">
